...
int main()
{
    ...
    shared_ptr<xMat> ms1 = make_shared<Metal>(XRGB{{0.8,0.8,0.8}}, 0.3);
    shared_ptr<xMat> ms2 = make_shared<Dielectric>(1.5);
    shared_ptr<xMat> ms3 = make_shared<Metal>(XRGB{{0.6,0.8,0.2}}, 1.0);
    ...
    world.add(make_shared<xSphere>(XV3{{1.0,0,-1}},0.25,ms3));
